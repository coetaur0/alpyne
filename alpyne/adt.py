...
class Sort(object):
    ...
    define terms of the sort. Rewrite rules can also be defined on terms of a
    sort to reduce them.
    """
    ...
    def operation(self, name, signature, sort=None):
        """
        Create a new operation on the sort. The operation is stored in the
        sort's attributes.
...
class Operation(object):
    ...
    An operation is similar to a function that takes arguments of given sorts
    as input and returns a value of a given sort.
    """
